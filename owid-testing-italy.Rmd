...
In Italy "swabs" ("tamponi") refers to ["performed tests"](https://github.com/pcm-dpc/COVID-19): many patients are tested several times (even 5/6 times). In particular, patients who are recovered from COVID-19 are tested at least 3 times (1 positive and 2 negative).
...
* [GIMBE & YouTrend study, *Il Sole 24 Ore*](https://www.sanita24.ilsole24ore.com/art/aziende-e-regioni/2020-04-02/coronavirus-cartabellotta-fondazione-gimbe-sovrastimato-numero-guariti-rischi-serve-chiarezza-orientare-scelte-103855.php?uuid=ADkV6eH)
...
The figures published at a given date attempt to include all tests conducted up to that date, but significant and variable delays are present: both from symptom onset to lab confirmation ($\Delta T_{symptoms}$) and from lab confirmation to official database update ($\Delta T_{lab}$). For example, in [Lombardy](https://arxiv.org/ftp/arxiv/papers/2003/2003.09320.pdf) $\Delta T_{symptoms}= 7.3 \text{ days } (1,20)_{95\% \text{CI}}$ and $\Delta T_{lab} = 3.6 \text{ days } (1,10)_{95\% \text{CI}}$. 
...
The most important documents are translated in English by the official sources. 
