...
In **Italy** (excluding Marche) "tamponi" ("swabs") refers to "performed tests": many patients are tested more than once. **(*high confidence* | [DPC](https://github.com/pcm-dpc/COVID-19), [YT](https://www.youtrend.it/2020/03/25/coronavirus-il-rebus-dei-tamponi-multipli/))**
...
National and regional data on "individuals tested" has been publicly available since 19-04. **(*high confidence* | [DPC](https://github.com/pcm-dpc/COVID-19))**
